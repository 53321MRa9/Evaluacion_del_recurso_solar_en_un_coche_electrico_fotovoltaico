...
# lat, lon = 40.4366002970,-3.5970436192  # Latitud y Longitud
localizacion = str(lat) + ',' + str(lon)
rumbo = 180  # Orientación N(0), E(90), S(180), O(270)
...
inicio = datetime.datetime(2019, 3, 30, 0, 0, 0)  # Inicio (Y,M,D,h,m,s)
fin = datetime.datetime(2019, 3, 31, 0, 0, 0)  # Fin (Y,M,D,h,m,s)
